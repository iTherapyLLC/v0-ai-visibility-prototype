      ...
      <section className="py-24 px-6 bg-white" ref={servicesFade.ref}>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-[#FAF8F5] border-0 shadow-lg hover:shadow-xl hover:shadow-[#B87333]/10 hover:-translate-y-2 transition-all duration-300 group">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-[#B87333]/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-[#B87333]/20 group-hover:scale-110 transition-all duration-300">
